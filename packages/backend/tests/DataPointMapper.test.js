    ...
    describe('dataPointToDataPointProps', () => {
        ...
        describe('Error Handling', () => {
            test('should throw error for null DataPoint', () => {
                expect(() => dataPointToDataPointProps(null)).toThrow('Invalid DataPoint');
            });
            test('should throw error for undefined DataPoint', () => {
                expect(() => dataPointToDataPointProps(undefined)).toThrow('Invalid DataPoint');
            });
        });
    });
...
//# sourceMappingURL=DataPointMapper.test.js.map