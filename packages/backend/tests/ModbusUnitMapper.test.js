    ...
    describe('unitToUnitProps', () => {
        ...
        describe('Error Handling', () => {
            test('should throw error for null ModbusUnit', () => {
                expect(() => unitToUnitProps(null)).toThrow('Invalid ModbusUnit');
            });
            test('should throw error for undefined ModbusUnit', () => {
                expect(() => unitToUnitProps(undefined)).toThrow('Invalid ModbusUnit');
            });
        });
    });
    describe('unitFromObject', () => {
        describe('Valid Object Conversions', () => {
            ...
            test('should create ModbusUnit with boundary unitId values', () => {
                ...
                if (result1.success)
                    expect(result1.value.getId()).toBe(1);
                if (result2.success)
                    expect(result2.value.getId()).toBe(254);
            });
...
//# sourceMappingURL=ModbusUnitMapper.test.js.map